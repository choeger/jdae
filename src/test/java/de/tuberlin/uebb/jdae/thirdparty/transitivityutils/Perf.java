...
class Perf {
    ...
    private static int countIntervals(TransitiveRelation r) throws Exception {
        Field nodeMap = DefaultTransitiveRelation.class
                .getDeclaredField("nodeMap");
        nodeMap.setAccessible(true);
        Map map = (Map) nodeMap.get(r);
        Field intervalSet = Class.forName(
                "edu.bath.transitivityutils.DefaultTransitiveRelation$Node")
                .getDeclaredField("intervalSet");
