...
public class OrderListTest {
    ...
    private OrderList<Integer> genericTest(Chooser chooser) {
        ...
        for (Node<Integer> node = list.base().next(); node != list.base(); node = node
                .next()) {
    ...
    public void simpleTest() {
        ...
        OrderList.Node<Void> n1 = (OrderList.Node<Void>) list
                .addAfter(n0, null);
        OrderList.Node<Void> n2 = (OrderList.Node<Void>) list
                .addAfter(n1, null);
        OrderList.Node<Void> n3 = (OrderList.Node<Void>) list
                .addAfter(n2, null);
