...
/* Original: Copyright (c) 2012 Kevin L. Stern */
 ...
 * 
 * This version has been modified for integer problems in jdae.
 * 
 * @author Kevin L. Stern
 * @author Christoph Höger
 */
public class HungarianIntegerAlgorithm {
     ...
     *            same length.
     */
    public HungarianIntegerAlgorithm(int[][] costMatrix) {
        this.dim = Math.max(costMatrix.length, costMatrix[0].length);
        this.rows = costMatrix.length;
        this.cols = costMatrix[0].length;
        this.costMatrix = new int[rows][];
