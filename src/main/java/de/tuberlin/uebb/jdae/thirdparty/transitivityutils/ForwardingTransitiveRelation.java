...
/**
 * A transitive relation which forwards all its method calls to another
 * transitive relation.
 * 
 * @author Andreou Dimitris, email: jim.andreou (at) gmail.com
 */
public abstract class ForwardingTransitiveRelation<E> extends ForwardingObject
        implements TransitiveRelation<E> {
    @Override
