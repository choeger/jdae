...
/**
 * A transitive bidirectional relation which forwards all its method calls to
 * another transitive bidirectional relation.
 * 
 * @author Andreou Dimitris, email: jim.andreou (at) gmail.com
 */
public abstract class ForwardingTransitiveBiRelation<E> extends
        ForwardingObject implements TransitiveBiRelation<E> {
    @Override
